...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// input_cnp
			// 
			this->input_cnp->Location = System::Drawing::Point(44, 33);
			this->input_cnp->Multiline = true;
			this->input_cnp->Name = L"input_cnp";
			this->input_cnp->Size = System::Drawing::Size(249, 73);
			this->input_cnp->TabIndex = 0;
			// 
			// afisaj_cnp
			// 
			this->afisaj_cnp->Location = System::Drawing::Point(44, 229);
			this->afisaj_cnp->Multiline = true;
			this->afisaj_cnp->Name = L"afisaj_cnp";
			this->afisaj_cnp->Size = System::Drawing::Size(249, 73);
			this->afisaj_cnp->TabIndex = 1;
			// 
			// calculeaza_cnp
			// 
			this->calculeaza_cnp->Location = System::Drawing::Point(44, 148);
			this->calculeaza_cnp->Name = L"calculeaza_cnp";
			this->calculeaza_cnp->Size = System::Drawing::Size(105, 36);
			...
			// stergere
			// 
			this->stergere->Location = System::Drawing::Point(188, 148);
			this->stergere->Name = L"stergere";
			this->stergere->Size = System::Drawing::Size(105, 36);
			...
			this->ClientSize = System::Drawing::Size(432, 391);
